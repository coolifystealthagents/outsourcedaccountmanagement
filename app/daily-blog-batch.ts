...
const august13Topics = [
  ['philippines-account-management-account-segment-review', 'Philippines account management account segment review', 'account-reporting', '2026-08-13'],
  ['philippines-account-management-stakeholder-coverage-map', 'Philippines account management stakeholder coverage map', 'client-onboarding-coordination', '2026-08-13'],
  ['philippines-account-management-renewal-objection-atlas', 'Philippines account management renewal objection atlas', 'renewal-administration', '2026-08-13'],
  ['philippines-account-management-qbr-question-ladder', 'Philippines account management QBR question ladder', 'customer-qbr-preparation', '2026-08-13'],
  ['philippines-account-management-crm-activity-context', 'Philippines account management CRM activity context', 'crm-account-maintenance', '2026-08-13'],
  ['philippines-account-management-request-priority-brief', 'Philippines account management request priority brief', 'client-request-routing', '2026-08-13'],
  ['philippines-account-management-expansion-readiness-signals', 'Philippines account management expansion readiness signals', 'upsell-opportunity-tracking', '2026-08-13'],
  ['philippines-account-management-executive-update-evidence', 'Philippines account management executive update evidence', 'account-reporting', '2026-08-13'],
  ['philippines-account-management-milestone-acceptance-criteria', 'Philippines account management milestone acceptance criteria', 'contract-milestone-tracking', '2026-08-13'],
  ['philippines-account-management-feedback-response-loop', 'Philippines account management feedback response loop', 'customer-feedback-administration', '2026-08-13'],
  ['philippines-account-management-post-launch-adoption-check', 'Philippines account management post-launch adoption check', 'implementation-handoff-support', '2026-08-13'],
  ['philippines-account-management-escalation-owner-ladder', 'Philippines account management escalation owner ladder', 'escalation-coordination', '2026-08-13'],
  ['philippines-account-management-value-realization-narrative', 'Philippines account management value realization narrative', 'account-reporting', '2026-08-13'],
  ['philippines-account-management-renewal-risk-conversation', 'Philippines account management renewal risk conversation', 'renewal-administration', '2026-08-13'],
  ['philippines-account-management-health-score-calibration', 'Philippines account management health score calibration', 'account-health-monitoring', '2026-08-13'],
  ['philippines-account-management-onboarding-success-criteria', 'Philippines account management onboarding success criteria', 'client-onboarding-coordination', '2026-08-13'],
  ['philippines-account-management-qbr-decision-ownership', 'Philippines account management QBR decision ownership', 'customer-qbr-preparation', '2026-08-13'],
  ['philippines-account-management-crm-contact-hygiene', 'Philippines account management CRM contact hygiene', 'crm-account-maintenance', '2026-08-13'],
  ['philippines-account-management-escalation-communication-plan', 'Philippines account management escalation communication plan', 'escalation-coordination', '2026-08-13'],
  ['philippines-account-management-portfolio-capacity-review', 'Philippines account management portfolio capacity review', 'account-reporting', '2026-08-13'],
  ['philippines-account-management-client-voice-priority-map', 'Philippines account management client voice priority map', 'customer-feedback-administration', '2026-08-13'],
  ['philippines-account-management-commitment-status-review', 'Philippines account management commitment status review', 'contract-milestone-tracking', '2026-08-13'],
] as const;
/*
