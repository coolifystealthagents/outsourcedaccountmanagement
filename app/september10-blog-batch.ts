...
const topics: SeptemberBlogTopic[] = [
  ...
  ['client-request-acceptance-test', 'Client request acceptance test', 'client-request-routing', 'define how the team will verify that a completed client request met the stated need', 'request wording, accepted outcome, evidence, verifier, exception, response state, and reopen rule', 'Finishing the assigned task does not always answer the request the client actually made.', '2026-08-31-client-silence-follow-up-rule.png'],
