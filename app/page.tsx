    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Account management boutique</p>
          <h1>Outsourced Account Management: a client success salon for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced account management guide for agencies and B2B teams needing client follow-up and account support. The page now uses a distinct boutique agency layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>relationship rings and concierge panels</figcaption></figure>
      </div>
    </section>
